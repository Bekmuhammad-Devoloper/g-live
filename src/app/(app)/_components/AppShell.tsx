...
const SUBMENUS: Record<string, { title: Record<Locale, string>; groups: SubGroup[] }> = {
  ...
  "/reports": {
    ...
    groups: [
      { items: [
        { href: "/reports/conversion", icon: "chart", label: L("Konversiya hisobotlari", "Отчёты по конверсии", "Conversion reports", "Konversionsberichte"), roles: [ROLES.DIRECTOR, ROLES.DEPUTY_DIRECTOR, ROLES.ROP, ROLES.MANAGER] },
        { href: "/reports/attendance", icon: "check", label: L("Davomat hisobotlari", "Отчёты по посещаемости", "Attendance reports", "Anwesenheitsberichte") },
        { href: "/reports/leads", icon: "download", label: L("Lidlar hisobotlari", "Отчёты по лидам", "Lead reports", "Lead-Berichte") },
        { href: "/reports/left-students", icon: "personMinus", label: L("Guruhni tark etganlar", "Покинувшие группу", "Left the group", "Ausgetretene Schüler") },
      ] },
      { label: L("Jurnallar", "Журналы", "Logs", "Protokolle"), items: [
        { href: "/reports/sms", icon: "mail", label: L("Yuborilgan SMS jurnali", "Журнал отправленных SMS", "Sent SMS log", "SMS-Versandprotokoll") },
        { href: "/reports/calls", icon: "phone", label: L("Qo'ng'iroqlar jurnali", "Журнал звонков", "Call log", "Anrufprotokoll") },
        { href: "/audit", icon: "listView", label: L("Audit jurnali", "Журнал аудита", "Audit log", "Audit-Protokoll") },
        { href: "/teacher-attendance", icon: "clock", label: L("Workly hisoboti", "Отчёт Workly", "Workly report", "Workly-Bericht") },
      ] },
      { label: L("Moliya", "Финансы", "Finance", "Finanzen"), items: [
        { href: "/reports/balance", icon: "wallet", label: L("Balans", "Баланс", "Balance", "Bilanz") },
        { href: "/reports/payments", icon: "refresh", label: L("Kirim chiqim (tushum)", "Приход/расход (выручка)", "Income/expenses (revenue)", "Einnahmen/Ausgaben (Umsatz)") },
        { href: "/reports/cancelled", icon: "fileX", label: L("Bekor qilingan to'lovlar", "Отменённые платежи", "Cancelled payments", "Stornierte Zahlungen") },
      ] },
      { label: L("O'quv", "Учебное", "Education", "Bildung"), items: [
        { href: "/reports/teacher-performance", icon: "teacher", label: L("O'qituvchilar samaradorligi", "Эффективность преподавателей", "Teacher performance", "Lehrerleistung") },
        { href: "/reports/admin-performance", icon: "users", label: L("Adminlar samaradorligi", "Эффективность администраторов", "Admin performance", "Admin-Leistung") },
        { href: "/reports/leave-reasons", icon: "info", label: L("Ketish sabablari", "Причины ухода", "Leave reasons", "Kündigungsgründe") },
        { href: "/reports/rooms-analytics", icon: "building", label: L("Xonalar analitikasi", "Аналитика кабинетов", "Room analytics", "Raumanalyse") },
        { href: "/reports/worked-hours", icon: "clock", label: L("Ishlab berilgan soatlar", "Отработанные часы", "Worked hours", "Geleistete Stunden") },
        { href: "/reports/cancelled-attendance", icon: "fileX", label: L("Bekor qilingan davomatlar", "Отменённые посещения", "Cancelled attendance", "Stornierte Anwesenheiten") },
      ] },
    ],
  },
  ...
  "/control": {
    ...
    groups: [
      { label: L("Amallar", "Действия", "Actions", "Aktionen"), items: [
        { href: "/attendance", icon: "check", label: L("Davomat", "Посещаемость", "Attendance", "Anwesenheit") },
        { href: "/reports/attendance", icon: "chart", label: L("Davomat analitikasi", "Аналитика посещаемости", "Attendance analytics", "Anwesenheitsanalyse") },
        { href: "/control/feedback", icon: "info", label: L("Fikr-mulohaza", "Обратная связь", "Feedback", "Rückmeldung") },
      ] },
      { label: L("Hisobotlar", "Отчёты", "Reports", "Berichte"), items: [
        { href: "/reports/staff-rating", icon: "trophy", label: L("Xodimlar reytingi", "Рейтинг сотрудников", "Staff rating", "Mitarbeiterbewertung") },
        { href: "/reports/no-attendance", icon: "layers", label: L("Davomatsiz guruhlar", "Группы без посещаемости", "Groups without attendance", "Gruppen ohne Anwesenheit") },
        { href: "/reports/branches-status", icon: "building", label: L("Filiallar holati", "Состояние филиалов", "Branch status", "Filialstatus") },
        { href: "/control/turnstile", icon: "shieldCheck", label: L("Turniket analitikasi", "Аналитика турникета", "Turnstile analytics", "Drehkreuz-Analyse") },
        { href: "/control/turnstile-log", icon: "shieldCheck", label: L("Turniket kirish-chiqish", "Турникет: вход/выход", "Turnstile entry/exit", "Drehkreuz Ein-/Ausgang") },
        { href: "/control/support", icon: "eye", label: L("Qo'llab-quvvatlash", "Поддержка", "Support", "Support") },
      ] },
    ],
  },
  "/finance": {
    ...
    groups: [
      { items: [
        { href: "/finance/payments", icon: "coins", label: L("Barcha to'lovlar", "Все платежи", "All payments", "Alle Zahlungen") },
        { href: "/finance/withdrawals", icon: "coins", label: L("Yechib olish", "Вывод средств", "Withdrawals", "Auszahlung") },
  ...
  "/marketing": {
    ...
    groups: [
      { label: L("Marketing"), items: [
        ...
        { href: "/settings/sms", icon: "mail", label: L("SMS shablonlari", "SMS-шаблоны", "SMS templates", "SMS-Vorlagen") },
        { href: "/reports/sms", icon: "listView", label: L("Xabarlar ro'yhati", "Список сообщений", "Message list", "Nachrichtenliste") },
      ] },
      { label: L("Sotuv bo'limi", "Отдел продаж", "Sales dept.", "Vertriebsabteilung"), items: [
        { href: "/rop", icon: "chart", label: L("ROP Dashboard") },
        { href: "/operator", icon: "headphones", label: L("Operator konsoli", "Консоль оператора", "Operator console", "Operator-Konsole") },
