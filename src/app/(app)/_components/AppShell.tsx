  ...
  "/settings": {
    ...
    groups: [
      ...
      { items: [
        ...
        { href: "/settings/coins", icon: "coins", label: { uz: "Tanga qoidalari", ru: "Правила монет", en: "Coin rules", de: "Münz-Regeln" }, roles: [ROLES.DIRECTOR, ROLES.DEPUTY_DIRECTOR, ROLES.ADMIN] },
