...
const SHORTCUTS: [string, { uz: string; ru: string; en: string; de?: string }][] = [
  ...
  ["g → d", { uz: "Filter: Daraja testi", ru: "Фильтр: Тест уровня", en: "Filter: Level test", de: "Filter: Einstufungstest" }],
  ["g → t", { uz: "Filter: Taklif", ru: "Фильтр: Предложение", en: "Filter: Offer", de: "Filter: Angebot" }],
