...
export function columnOfLead(
  lead: { stage: string; groupId: string | null; kanbanColumnId?: string | null; branchId?: string | null; studyFormat?: string | null; archivedAt?: string | null; studentId?: string | null },
  pinned: Set<string>,
