    ...
    <>
      ...
      <div className="mb-6 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        {CAN_MANAGE.includes(s.role as never) && (
          ...
          <HubCard href="/settings/coins" icon="coins" title={tr(s.locale, { uz: "Tanga qoidalari", ru: "Правила монет", en: "Coin rules", de: "Münz-Regeln" })} desc={tr(s.locale, { uz: "Dars, vazifa, o'yin va daraja uchun necha tanga", ru: "Сколько монет за урок, задание, игру и уровень", en: "Coins for lessons, tasks, games and levels", de: "Münzen für Lektionen, Aufgaben, Spiele und Niveaus" })} />
          </>
        )}
