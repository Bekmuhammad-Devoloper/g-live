    ...
    <>
      ...
      <div className="mb-6 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        {CAN_MANAGE.includes(s.role as never) && (
          ...
          <HubCard href="/settings/home" icon="layout" title={tr(s.locale, { uz: "Bosh sahifa", ru: "Главная страница", en: "Home page", de: "Startseite" })} desc={tr(s.locale, { uz: "Bannerlar va YouTube videolari", ru: "Баннеры и видео с YouTube", en: "Banners and YouTube videos", de: "Banner und YouTube-Videos" })} />
          ...
          <HubCard href="/settings/coins" icon="coins" title={tr(s.locale, { uz: "Ball va mukofotlar", ru: "Баллы и награды", en: "Points and rewards", de: "Punkte und Belohnungen" })} desc={tr(s.locale, { uz: "Tanga, seriya va reyting qoidalari", ru: "Сколько монет за урок, задание, игру и уровень", en: "Coins for lessons, tasks, games and levels", de: "Münzen für Lektionen, Aufgaben, Spiele und Niveaus" })} />
          <HubCard href="/settings/star-ranks" icon="trophy" title={tr(s.locale, { uz: "Yulduz darajalari", ru: "Звёздные уровни", en: "Star ranks", de: "Sternenstufen" })} desc={tr(s.locale, { uz: "Yulduz yig'ib ko'tariladigan pog'onalar va tanga mukofoti", ru: "Ступени за звёзды и награда монетами", en: "Ranks earned with stars and their coin rewards", de: "Stufen für Sterne und ihre Münzbelohnung" })} />
          </>
        )}
