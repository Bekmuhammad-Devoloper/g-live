...
export default async function TelephonyPage() {
  ...
  if (!ALLOWED.includes(s.role as never)) {
    return <Forbidden title={tr(s.locale, { uz: "Kirish taqiqlangan", ru: "Доступ запрещён", en: "Access denied" })} body={tr(s.locale, { uz: "Telefoniya sozlamalari faqat direktor va administrator uchun.", ru: "Настройки телефонии доступны только директору и администратору.", en: "Telephony settings are available only to the director and administrator." })} />;
  }
