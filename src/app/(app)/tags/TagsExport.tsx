...
export default function TagsExport({ rows, locale }: { rows: TagRow[]; locale: Locale }) {
  const exportCsvNow = () =>
    exportRows(
      tr(locale, { uz: "teglar", ru: "теги", en: "tags", de: "Tags" }),
      [
        { key: "name", label: tr(locale, { uz: "Nomi", ru: "Название", en: "Name", de: "Name" }) },
        { key: "code", label: tr(locale, { uz: "Kodi", ru: "Код", en: "Code", de: "Code" }) },
        { key: "active", label: tr(locale, { uz: "Holati", ru: "Статус", en: "Status", de: "Status" }) },
      ],
