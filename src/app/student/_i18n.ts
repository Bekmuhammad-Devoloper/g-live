...
const DICT = {
  ...
  calTotal: p("Jami", "Всего", "Total", "Gesamt"),
  calPassed: p("O'tdi", "Прошло", "Passed", "Vorbei"),
  calLeft: p("Qoldi", "Осталось", "Left", "Übrig"),
  calNoLesson: p("bu kuni dars yo'q", "в этот день урока нет", "no lesson that day", "an diesem Tag kein Unterricht"),
  calTapHint: p("Kunni bosing — dars vaqti va xonasi chiqadi", "Нажмите на день — покажем время и аудиторию", "Tap a day to see the time and room", "Tippe auf einen Tag für Zeit und Raum"),
  calAttended: p("Kelgan", "Был", "Attended", "Anwesend"),
  calLate: p("Kechikkan", "Опоздал", "Late", "Verspätet"),
  calAbsent: p("Kelmagan", "Не был", "Absent", "Gefehlt"),
  calExcused: p("Sababli", "По причине", "Excused", "Entschuldigt"),
