...
export default function KurseActions() {
  return (
    <div className="flex shrink-0 items-center gap-2">
      <Link href="/student/worterbuch" aria-label="Wörterbuch" title="Lug'at" className={BTN}>
      ...
      <Link href="/student/lehrer" aria-label="Ustozga yozish" title="Ustozga yozish" className={BTN}>
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={TEAL} strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
