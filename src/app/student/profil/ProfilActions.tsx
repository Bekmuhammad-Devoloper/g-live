...
export default function ProfilActions() {
  return (
    <div className="flex shrink-0 items-center gap-2">
      <Link href="/student/market" aria-label="Market" title="Market" className={BTN}>
      ...
      <Link href="/student/einstellungen" aria-label="Sozlamalar" title="Sozlamalar" className={BTN}>
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={TEAL} strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
